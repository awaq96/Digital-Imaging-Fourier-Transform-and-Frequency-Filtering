...
def main():
    ...
    output_image_name = output_dir+image_name+"_"+mask+".jpg"
    cv2.imwrite(output_image_name, output[0])
    output_image_name = output_dir + image_name+"_dft_" + mask + ".jpg"
    cv2.imwrite(output_image_name, output[1])
    output_image_name = output_dir + image_name + "_dft_filter_" + mask + ".jpg"
